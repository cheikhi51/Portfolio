...
function Education() {
  ...
  <h1 className="text-5xl flex justify-center text-white mb-16 education-section-title">Education</h1>
  <div className="card-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    {/* Card 1 */}
    <div className="card relative flex flex-col items-center text-center p-6 rounded-lg bg-white hover:text-white shadow-md transition-all duration-300 hover:bg-gradient-to-r from-blueviolet to-teal">
    ...
    {/* card 2 */}
    <div className="card relative flex flex-col items-center text-center p-6 rounded-lg hover:text-white bg-white shadow-md transition-all duration-300 hover:bg-gradient-to-r from-blueviolet to-teal">
